...
let nulis = async (m, { conn: Ditss, text }) => {
...
.nulis Ini catatan harian||20 Juni 2025` }, { quoted: m });
 ...
 if (!isi) return Ditss.sendMessage(m.chat, { text: '⚠️ Isi tulisan tidak boleh kosong.' }, { quoted: m });
 try {
 ...
 await Ditss.sendMessage(m.chat, { text: errorMessage }, { quoted: m });
 }
}
