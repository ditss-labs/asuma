...
let carigc = async (m, { conn: Ditss, text, command, reply, usedPrefix }) => {
  ...
  try {
    let res = await axios.get(`https://www.ditss.biz.id/api/search/group?q=${encodeURIComponent(text)}&apikey=demo`);
    let data = res.data;
